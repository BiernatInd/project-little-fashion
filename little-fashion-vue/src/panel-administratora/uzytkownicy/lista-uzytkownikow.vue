<template>
    ...
    <div class="home">
      <table>
        ...
        <tbody>
          <tr v-for="uzytkownik in uzytkownicy" :key="uzytkownik.id">
            <td data-label="Numer">{{ uzytkownik.id }}</td>
            <td data-label="Nazwa użytkownika">{{ uzytkownik.name }}</td>
            <td data-label="E-mail"> {{ uzytkownik.email }}</td>
            <td data-label="Data">{{ formatData(uzytkownik.created_at) }}</td>
            <td data-label="Szczegóły">
                <svg width="21" height="22" viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg" @click="showConfirmation(uzytkownik.id)">
        ...
        <div class="confirmation-main">
            ...
            <div class="confirmation-bottom">
                ...
                <div class="confirmation-buttons">
                    ...
                    <button class="confirmation-btn" @click="deleteUzytkownik">Usuń</button>
                </div>
            </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    fetchData() {
        axios.get('http://localhost:8000/api/pobierz-uzytkownikow')
    .then(response => {
    ...
    deleteUzytkownik() {
      ...
      axios
        .delete(`http://localhost:8000/api/usun-uzytkownika/${this.selectedUzytkownikId}`)
        .then(response => {
    ...
    showConfirmation(uzytkownikId) {
      console.log('showConfirmation');
      this.confirmationActive = !this.confirmationActive;
      this.selectedUzytkownikId = uzytkownikId; // Dodaj zmienną do przechowywania ID wybranego produktu
