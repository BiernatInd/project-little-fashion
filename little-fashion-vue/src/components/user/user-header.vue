...
<header class="header" :class="{ sticky: isHeaderSticky }">
      <nav class="nav">
        ...
        <div class="nav-right">
          ...
          <UserSlideLeft :isActive="isActive" @toggleUserMenu="toggleUserMenu" />
          <UserSlideMenu :isMainMenuActive="isMainMenuActive" @toggleMainMenu="toggleMainMenu" />
</template>
    
<script>
import UserSlideLeft from './user-slide-left.vue';
import UserSlideMenu from './user-slide-menu.vue';
