<template>
 <div class="main-menu" :class="{ active: mainMenuActive, sticky: isMenuSticky }">
        <div class="main-menu-content">
            <div class="main-menu-top">
                ...
                <div class="main-menu-links">
                    ...
                    <div :class="{ 'main-menu-link': true, 'active': shopSubMenuActive }" @click="toggleShopSubMenu">
                        <a>Nasz sklep</a>
                        <img src="../../assets/icons/12.svg" alt="">
                    </div>
                    <div v-if="shopSubMenuActive" class="main-menu-link-child active">
...
export default {
  ...
  computed: {
    ...mapState(['mainMenuActive', 'shopSubMenuActive'])
  },
  mounted() {
  ...
  methods: {
    ...mapActions(['setMainMenuActive', 'setShopSubMenuActive']),
    toggleMainMenu() {
    ...
    toggleShopSubMenu() {
      this.setShopSubMenuActive(!this.shopSubMenuActive);
    },
    removeActiveClass() {
      this.setMainMenuActive(false);
